...
def cut_image(dilate, img):
    ...
    weightsPath = os.path.sep.join([args["yolo"], "yolov3-tinySPP_best.weights"])
    configPath = os.path.sep.join([args["yolo"], "yolov3-tinySPP.cfg"])

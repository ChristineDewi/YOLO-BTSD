...
def cut_image(dilate, img):
    ...
    weightsPath = os.path.sep.join([args["yolo"], "densenetsppBTSD_best.weights"])
    configPath = os.path.sep.join([args["yolo"], "densenetsppBTSD.cfg"])
...
save_path = "output/01/densenetspp/"

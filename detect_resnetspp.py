...
def cut_image(dilate, img):
    ...
    weightsPath = os.path.sep.join([args["yolo"], "resnet50SPP_BTSD_best.weights"])
    configPath = os.path.sep.join([args["yolo"], "resnet50SPP_BTSD.cfg"])
...
save_path = "results/002/resnetspp/"
